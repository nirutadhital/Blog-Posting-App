...
if(isset($_POST['submit'])){
   ...
   //set is_featured to 0 if unchecked
    ...
    //validate form data
    if (!$title){
        $_SESSION['edit-post']="Could not update post. invalid form data on edit post page.";
    } elseif (!$category_id){
        $_SESSION['edit-post']="Could not update post. invalid form data on edit post page.";
    } 
    //elseif (!$body){
    ...
    // } 
        ...
        //deleting the existing thumbnail if existing thumbnail is available
        if($thumbnail['name']) {
    ...
    if(isset($_SESSION['edit-post'])){
        $_SESSION['edit-post-data']=$_POST; //post super global
        ...
        //set thumbnail name if new one was uploaded, else keep old thumbnail anme
